...
export default function SignInPage() {
  ...
  const info = useMemo(() => {
    if (searchParams.get("verify") === "1") {
      return "Account created. Check your email for the verification link, then click it to finish signing in.";
    }
    return "";
  }, [searchParams]);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Redirect admin users to /dev, regular users to /dashboard
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-950">
      ...
      <div className="absolute left-1/2 top-1/3 -translate-x-1/2 -translate-y-1/2 h-[310px] w-[310px] rounded-full bg-indigo-500 opacity-15 blur-[120px] pointer-events-none" />
      ...
      >
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              required
              className="w-full rounded-lg border border-gray-700 bg-gray-800 px-4 py-2.5 text-white placeholder-gray-500 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-colors"
            />
          </div>
        ...
        {info && (
          <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/10 px-4 py-2.5 text-center text-sm text-emerald-300">
            {info}
          </div>
        )}
        ...
        <button
          ...
          className="w-full rounded-lg bg-indigo-600 px-4 py-2.5 font-medium text-white transition-all hover:bg-indigo-500 disabled:opacity-50 shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_30px_rgba(99,102,241,0.5)]"
        >
          {loading ? (
